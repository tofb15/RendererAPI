...
plot \
file using (0.000000):8:xticlabels(1) w boxplot t "Scene-0",\
file using (0.100000):24:xticlabels(1) w boxplot t "Scene-1",\
file using (0.200000):40:xticlabels(1) w boxplot t "Scene-2",\
file using (0.300000):56:xticlabels(1) w boxplot t "Scene-3",\
