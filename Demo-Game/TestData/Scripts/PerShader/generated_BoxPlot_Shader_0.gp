...
plot \
file using (0.000000):1:xticlabels(1) w boxplot t "Scene-0",\
file using (0.100000):17:xticlabels(1) w boxplot t "Scene-1",\
file using (0.200000):33:xticlabels(1) w boxplot t "Scene-2",\
file using (0.300000):49:xticlabels(1) w boxplot t "Scene-3",\
