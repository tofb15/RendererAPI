...
plot \
file using (0.000000):10:xticlabels(1) w boxplot t "Scene-0",\
file using (0.100000):26:xticlabels(1) w boxplot t "Scene-1",\
file using (0.200000):42:xticlabels(1) w boxplot t "Scene-2",\
file using (0.300000):58:xticlabels(1) w boxplot t "Scene-3",\
