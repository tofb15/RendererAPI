...
plot \
file using (0.000000):11:xticlabels(1) w boxplot t "Scene-0",\
file using (0.100000):27:xticlabels(1) w boxplot t "Scene-1",\
file using (0.200000):43:xticlabels(1) w boxplot t "Scene-2",\
file using (0.300000):59:xticlabels(1) w boxplot t "Scene-3",\
