...
plot \
"../../Data/Forest_BC7#0.data" using 1 w lines lc 0 t "Forest_BC7",\
"../../Data/Forest_RGBA#0.data" using 1 w lines lc 1 t "Forest_RGBA",\
"../../Data/Scene0_BC7#0.data" using 1 w lines lc 2 t "Scene0_BC7",\
"../../Data/Scene0_RGBA#0.data" using 1 w lines lc 3 t "Scene0_RGBA",\
