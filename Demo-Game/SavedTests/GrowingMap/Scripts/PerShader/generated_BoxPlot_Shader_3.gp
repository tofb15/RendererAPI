...
"../../Data/Scene3#3.data" using (0.300000):1:xticlabels(1) w boxplot t "Scene3",\
"../../Data/Scene4#3.data" using (0.400000):1:xticlabels(1) w boxplot t "Scene4",\
"../../Data/Scene5#3.data" using (0.500000):1:xticlabels(1) w boxplot t "Scene5",\
