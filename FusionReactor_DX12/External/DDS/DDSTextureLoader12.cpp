...
#include "FusionReactor_DX12/DXR/DXRUtils.h"
...
#define ISBITMASK( r,g,b,a ) ( ddpf.RBitMask == r && ddpf.GBitMask == g && ddpf.BBitMask == b && ddpf.ABitMask == a )
	...
	HRESULT CreateTextureResource(
		...
		*texture = D3D12Utils::CreateBuffer(d3dDevice, desc.DepthOrArraySize, desc.Flags, D3D12_RESOURCE_STATE_COPY_DEST, D3D12Utils::sDefaultHeapProps, &desc);
	...
	HRESULT CreateTextureFromDDS(_In_ ID3D12Device5* d3dDevice,
		...
		if (FAILED(d3dDevice->CheckFeatureSupport(D3D12_FEATURE_FORMAT_INFO, &formatInfo, sizeof(formatInfo)))) {
			return 0;
		}
		UINT numberOfPlanes = formatInfo.PlaneCount;
		if (!numberOfPlanes)
			return E_INVALIDARG;
